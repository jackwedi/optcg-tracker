...
// stays visually distinct from the orange create-card directly below it.
export function TodayTournamentBanner({
  tournament,
}: TodayTournamentBannerProps) {
  return (
    <div className="flex flex-col gap-4 rounded-2xl border-2 border-emerald-200 bg-gradient-to-br from-emerald-50 via-white to-white p-6 shadow-md dark:border-emerald-800 dark:from-emerald-950 dark:via-slate-800 dark:to-slate-800 sm:flex-row sm:items-center sm:justify-between sm:p-8">
      <div className="flex items-center gap-4">
        <span
          className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-2xl shadow-sm dark:bg-emerald-500/20"
          aria-hidden="true"
        >
          🔥
        </span>
