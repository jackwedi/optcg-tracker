...
export function TodayTournamentBanner({
  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl border-2 border-emerald-200 bg-gradient-to-br from-emerald-50 via-white to-white p-6 shadow-md sm:flex-row sm:items-center sm:justify-between sm:p-8">
      <div className="flex items-center gap-4">
        <span
          className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-2xl shadow-sm"
          aria-hidden="true"
        >
          🔥
        </span>
