...
export function CrewRankProgress({ totalWins }: CrewRankProgressProps) {
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-800">
          ...
          <button
            ...
            className={`inline-flex h-4 w-4 shrink-0 items-center justify-center rounded-full border text-[10px] font-bold leading-none transition ${
              detailsOpen
                ...
                : "border-slate-300 text-slate-400 hover:border-slate-400 hover:text-slate-600 dark:border-slate-600 dark:text-slate-500 dark:hover:border-slate-500 dark:hover:text-slate-300"
            }`}
          >
            i
          </button>
      ...
      {detailsOpen ? (
        <>
          <div className="mt-3 grid grid-cols-1 gap-2 border-t border-slate-100 pt-3 dark:border-slate-700 sm:grid-cols-5">
                  ...
                  className={`rounded-lg border p-2 text-center transition ${
                    isCurrent
                      ...
                      : achieved
                        ...
                        : "border-slate-100 bg-white opacity-50 dark:border-slate-700 dark:bg-slate-800"
                  }`}
                >
