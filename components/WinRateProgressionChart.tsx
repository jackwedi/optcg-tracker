...
const GRID_COLOR = "#e2e8f0"; // slate-200, one step off the white surface
const AXIS_TEXT_COLOR = "#64748b"; // slate-500, muted ink
          ...
          <div className="relative">
            ...
            {active ? (
              ...
              >
                ...
                <p className="text-slate-500">{formatDate(active.date)}</p>
                ...
                <tbody className="divide-y divide-slate-100">
                  {points.map((p) => (
                    <tr key={p.date}>
                      ...
                      <td className="px-3 py-2 text-right">{p.dayRounds}</td>
                      <td className="px-3 py-2 text-right">{p.dayWins}</td>
